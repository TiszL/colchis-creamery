...
export default async function StaffProductsPage({ params }: { params: any }) {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-serif text-white mb-2">B2C Product Inventory</h1>
                <p className="text-gray-500 font-light">Manage retail products, pricing, and stock levels.</p>
            </div>
            <InventoryClient
                products={serialized}
