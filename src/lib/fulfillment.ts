...
/**
 * Returns true if a channel can fulfill an online cart order.
 * IN_STORE_DINE_IN is a sit-down-only channel — those products are eaten at the bakery,
 ...
 */
export function isCartEligibleChannel(channel: FulfillmentChannel): boolean {
    return channel !== 'IN_STORE_DINE_IN';
}
 ...
 */
export function cartEligibleChannels(channels: FulfillmentChannel[]): FulfillmentChannel[] {
