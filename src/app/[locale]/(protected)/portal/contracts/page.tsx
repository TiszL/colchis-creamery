                ...
                <table className="w-full text-left text-sm text-gray-400">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {b2bPartners.map((partner: any) => {
                            ...
                            return (
                                <tr key={partner.id} className="hover:bg-[#ffffff08] transition">
                                            ...
                                            <form action={generateContractAction} className="flex flex-col gap-2 items-center">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <input type="number" name="discount" defaultValue="15"
                                                        className="w-16 bg-[#0C0C0C] border border-[#B96A3D22] text-white rounded px-2 py-1 text-xs text-right focus:border-[#B96A3D]"
                                                        min="0" max="100" />
                                                    <span className="text-xs text-gray-500">%</span>
                                                </div>
                                                <button type="submit" className="text-xs bg-[#B96A3D] text-black px-3 py-1.5 rounded font-bold hover:bg-white transition">
                                                    Issue Contract
                                                </button>
                                            </form>
                                        )}
