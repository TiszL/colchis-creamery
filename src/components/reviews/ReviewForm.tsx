    ...
    if (!isLoggedIn) {
        return (
            <div className="bg-white rounded-lg border border-gray-100 p-8 text-center shadow-sm">
                ...
                <a href="/login" className="inline-block px-6 py-2.5 bg-[#CBA153] text-white font-bold text-sm rounded-lg hover:bg-[#8A6A28] transition-colors tracking-wider uppercase">
                    Sign In
                </a>
            </div>
        );
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-100 p-6 shadow-sm space-y-5">
            ...
            <button
                ...
                className="w-full py-3.5 bg-[#CBA153] text-white font-bold text-sm rounded-lg hover:bg-[#8A6A28] transition-colors tracking-wider uppercase disabled:opacity-50 disabled:cursor-not-allowed"
            >
