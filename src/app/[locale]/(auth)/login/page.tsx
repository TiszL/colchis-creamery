...
function LoginContent() {
    ...
    return (
        <main className="min-h-screen bg-cream flex flex-col items-center justify-center p-6 relative">
            ...
            <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded shadow-2xl border border-border-light relative z-10 animate-fade-in">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-charcoal/60 font-light text-sm">Sign in to manage your orders & preferences.</p>
                </div>
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white px-3 text-charcoal/50 font-bold tracking-widest">Or login with email</span>
                    </div>
                </div>
                ...
                <p className="text-center text-sm text-charcoal/60 mt-8">
                    ...
                    <Link href="/register" className="text-gold font-bold hover:text-charcoal transition-colors">Sign up</Link>
                </p>
