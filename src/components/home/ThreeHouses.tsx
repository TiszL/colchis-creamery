...
const DEFAULTS = {
  ...
  houses: [
    { name: "The Creamery", ka: "ყველის სახლი", num: "I", tag: "Imeruli & Sulguni, hand-pressed", cta: "Shop cheese →", href: "/shop", desc: "Cow-milk Sulguni, brined fresh or aged with honey. Imeruli pulled in salted whey. Aged in our Dublin facility, shipped fresh nationwide.", dark: false },
