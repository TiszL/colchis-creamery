...
const PLAYBOOK_TIERS = [
  {
    ...
    sequence: [
      { touch: 1, day: 1, deliveryMethod: 'Phone Call', subject: 'Intro call — free sample offer', script: `Hi, my name is [Name] from Colchis Food — we're an Ohio-based Georgian cheese producer. I noticed you're serving khachapuri, and I'd love to drop off a free sample of our Imeruli and Sulguni to let the cheese speak for itself. Would you be open to a quick 5-minute tasting?` },
      { touch: 2, day: 3, deliveryMethod: 'In-Person Visit', subject: 'Free sample drop + live demo', script: `Bring 1-2 lb samples of Imeruli and Sulguni. If possible, show the melt/stretch properties. Leave a one-page pricing sheet and business card. Key message: 'Our shredded packs save your kitchen 30-45 minutes of prep per shift.'` },
      { touch: 3, day: 10, deliveryMethod: 'Follow-up Email', subject: 'How did [BusinessName] like the Georgian cheese sample?', script: `Subject: Your team's reaction to the Colchis sample?\n\nHi [Name],\n\nFollowed up after leaving the sample last week. Curious what your chef thought of the melt and stretch on the Sulguni — we've had bakeries tell us it reduces their khachapuri prep time significantly because they no longer need to shred in-house.\n\nI'd love to set up a 10-minute call to talk pricing for regular weekly delivery. What does next week look like?\n\n—[Your name], Colchis Food` },
      { touch: 4, day: 17, deliveryMethod: 'Phone Call', subject: 'Pricing discussion + first order setup', script: `Call to confirm interest and discuss minimum order quantities. Offer a 'first month' discount or a free 5-lb trial order to reduce risk. Ask: 'What's your current cheese supplier? Are you satisfied with delivery consistency?'` },
      { touch: 5, day: 30, deliveryMethod: 'Email', subject: 'Last chance — seasonal pricing ends soon', script: `Final urgency email. Mention limited batch availability or seasonal pricing. Offer to be their exclusive local Georgian cheese source.` },
    ],
    valueProps: [
  ...
  },
  {
    ...
    sequence: [
      { touch: 1, day: 1, deliveryMethod: 'Cold Email', subject: 'Your customers are asking for Georgian cheese — [BusinessName]', script: `Subject: Your customers are already asking for sulguni\n\nHi [Name],\n\nI run Colchis Food, an Ohio-based producer of authentic Georgian cheeses — Sulguni, Imeruli, and Smoked Sulguni.\n\nGeorgian cheese is one of the fastest-growing specialty dairy requests at Eastern European markets right now — your customers likely already know these cheeses from home.\n\nWe offer weekly delivery and can start with a small trial shipment. Can I send you a 2-lb sample?\n\n—[Name]` },
      { touch: 2, day: 7, deliveryMethod: 'Email Follow-Up', subject: 'Re: Georgian cheese for [BusinessName]', script: `Quick follow-up to my email from [date]. Attached is our current price list and product spec sheet. Our Sulguni compares directly to what you may be importing, but fresher and at competitive wholesale pricing.\n\nWould a 10-minute call this week work?` },
      { touch: 3, day: 14, deliveryMethod: 'Phone Call', subject: 'Follow-up call', script: `Reference your email, offer free sample delivery if they haven't responded. Ask about their current cheese supplier and delivery frequency.` },
      { touch: 4, day: 25, deliveryMethod: 'Email', subject: 'Other [city] stores are already stocking it', script: `Social proof email. Mention (if applicable) similar stores that have already ordered. Include a quote from a satisfied customer.` },
      { touch: 5, day: 45, deliveryMethod: 'Re-engagement', subject: 'Checking back in — new seasonal products', script: `Mention new product launches (smoked sulguni, nadughi) to create fresh interest.` },
    ],
    valueProps: [
  ...
  },
  {
    ...
    sequence: [
      { touch: 1, day: 1, deliveryMethod: 'Email', subject: 'Have you tried sulguni as a halloumi alternative?', script: `Subject: Better than halloumi for grilling — Georgian Sulguni\n\nHi [Name],\n\nGeorgian Sulguni cheese grills identically to halloumi — same elastic texture, similar salt level — but with a milkier, more complex flavor profile your guests will notice.\n\nI'd love to send you a 1-lb sample to try on your next menu R&D session. Colchis Food is Ohio-made, FDA compliant, and available for weekly delivery.\n\nWorth a taste?` },
      { touch: 2, day: 10, deliveryMethod: 'Email', subject: 'Sulguni on your specials board this week?', script: `Follow-up with a recipe idea specific to their menu type (e.g., pizza: 'Sulguni + fig + prosciutto white pie recipe').` },
      { touch: 3, day: 21, deliveryMethod: 'Email', subject: 'Quick question about your cheese sourcing', script: `Ask about their current specialty cheese supplier. Offer a competitive price comparison.` },
    ],
    valueProps: [
  ...
  },
  {
    ...
    sequence: [
      { touch: 1, day: 1, deliveryMethod: 'LinkedIn + Email', subject: 'Partnership proposal — Georgian cheese category for [Distributor]', script: `Subject: Filling a white space in your Georgian/Eastern European cheese category\n\nHi [Name],\n\nColchis Food is the only US-based producer of authentic Georgian cheeses (Sulguni, Imeruli, Smoked Sulguni) with FDA compliance and weekly production capacity.\n\nYour existing accounts — Georgian restaurants, Eastern European groceries, artisan markets — are actively asking their distributors for domestic Georgian cheese. We can fulfill that demand.\n\nI'd love 20 minutes to walk you through our product line and discuss a potential distribution partnership. Are you open to a call next week?` },
      { touch: 2, day: 10, deliveryMethod: 'Sample Shipment', subject: 'Sample package arriving [date]', script: `Ship a professional sample box: all products, spec sheets, shelf-life data, pricing, minimum order info, and a short origin story card.` },
      { touch: 3, day: 17, deliveryMethod: 'Phone Call', subject: 'Follow-up on sample package', script: `Detailed product discussion. Cover: shelf life, MOQ, lead time, cold chain logistics, pricing tiers.` },
      { touch: 4, day: 35, deliveryMethod: 'Email', subject: 'Q2 launch window — finalize details', script: `Create urgency around production calendar / Q2 launch timing. Provide draft distribution agreement terms.` },
    ],
    valueProps: [
